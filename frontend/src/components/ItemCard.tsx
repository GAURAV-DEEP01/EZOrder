        ...
        {!isUnavailable && (
          <div className="flex items-center space-x-2">
            <button
              ...
              className="flex text-white bg-blue-500 hover:bg-blue-700 font-semibold sm:py-2 sm:px-4 py-1 px-2 rounded-lg">
              Add
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24px"
            ...
            <input
              ...
              className="sm:w-16 w-10 p-2 border text-black rounded-lg text-center"
            />
          </div>
        )}
      </div>
